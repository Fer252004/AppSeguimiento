...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Editar Ficha de Caracterización</div>
                <div class="card-body">
                    <form action="{{ route('fichas.update', $ficha->NIS) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('Codigo') is-invalid @enderror"
                                   id="Codigo" name="Codigo" value="{{ old('Codigo', $ficha->Codigo) }}" required>
                            @error('Codigo')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('Denominacion') is-invalid @enderror"
                                   id="Denominacion" name="Denominacion" value="{{ old('Denominacion', $ficha->Denominacion) }}" required>
                            @error('Denominacion')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('tblprogramasdeformacion_NIS') is-invalid @enderror"
                                        ...
                                        @foreach($programas as $programa)
                                            <option value="{{ $programa->NIS }}" {{ old('tblprogramasdeformacion_NIS', $ficha->tblprogramasdeformacion_NIS) == $programa->NIS ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('tblcentrodeformacion_NIS') is-invalid @enderror"
                                        ...
                                        @foreach($centros as $centro)
                                            <option value="{{ $centro->NIS }}" {{ old('tblcentrodeformacion_NIS', $ficha->tblcentrodeformacion_NIS) == $centro->NIS ? 'selected' : '' }}>
                                                {{ $centro->Denominacion }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('Cupo') is-invalid @enderror"
                                           id="Cupo" name="Cupo" value="{{ old('Cupo', $ficha->Cupo) }}" required>
                                    @error('Cupo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('FechaInicio') is-invalid @enderror"
                                           id="FechaInicio" name="FechaInicio" value="{{ old('FechaInicio', $ficha->FechaInicio) }}" required>
                                    @error('FechaInicio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('FechaFin') is-invalid @enderror"
                                           id="FechaFin" name="FechaFin" value="{{ old('FechaFin', $ficha->FechaFin) }}" required>
                                    @error('FechaFin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('Observaciones') is-invalid @enderror"
                                      id="Observaciones" name="Observaciones" rows="3">{{ old('Observaciones', $ficha->Observaciones) }}</textarea>
                            @error('Observaciones')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
